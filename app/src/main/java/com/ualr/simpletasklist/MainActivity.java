...
public class MainActivity extends AppCompatActivity {
    ...
    public void onAddBtnClicked(View view){
        String addTask = binding.editTextTextPersonName.getText().toString();
        List.add(addTask);
    ...
    public void onDeleteBtnClicked(View view){
        String deleteTask = binding.editTextTaskId.getText().toString();
        List.delete(deleteTask);
        binding.taskList.setText(List.toString());
    }
    ...
    public void onDoneBtnClicked(View view){
        String doneTask = binding.editTextTaskId.getText().toString();
        int taskId = Integer.parseInt(doneTask);
